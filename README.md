...
Протокол `2.1` добавляет совместимый долгий запрос: новая команда обычно
доставляется за десятки миллисекунд без частого сетевого опроса.
...
- долгий запрос с немедленным пробуждением при появлении команды;
