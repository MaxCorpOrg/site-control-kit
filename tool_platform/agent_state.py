...
def default_agent_state() -> dict[str, Any]:
    ...
    return {
        ...
        "last_verified_artifacts": {
            ...
            "linux_deb": "packaging/dist/linux/telegram-control-center_0.1.0_all.deb",
            ...
            "windows_toolchain_check": "./packaging/windows/build_windows_installer.sh 0.1.0 --check-tools -> missing wine, winepath",
