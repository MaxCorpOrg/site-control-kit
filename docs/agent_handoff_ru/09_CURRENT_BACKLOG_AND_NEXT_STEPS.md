# Текущая очередь задач и следующие шаги

## Следующий Приоритет P0
### Ранний выход с учётом доставки для углублённого пути меню
...
## Отдельный контур: менеджер приглашений
...
### Разделить монолитный экспортёр
...
## Отдельный контур: единая платформа инструментов
