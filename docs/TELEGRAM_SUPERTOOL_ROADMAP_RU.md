# План развития единого инструмента Telegram
...
### 2.1. Графический интерфейс слишком много знает
...
### 2.3. Нет единого слоя выполнения заданий
...
### 2.4. Среда Telegram-инструментов разделена между несколькими формами
...
### Слой A. Транспорт и управление устройством
...
### Слой B. Среды выполнения инструментов
...
### Слой C. Движок рабочих сценариев
...
### Слой D. Единое хранилище заданий
...
### Слой E. Операторский центр управления
...
### Приоритет 1. Довести стабильность текущего центра управления
...
### Приоритет 2. Вынести оркестрацию из `gui.py`
...
### Приоритет 3. Сделать единый индекс заданий
...
### Приоритет 4. Сделать рабочую область вокруг профиля
...
### 5.2. Воспроизведение и объяснение
...
### 5.7. API управления без графического интерфейса
...
### 5.8. Набор средств разработки инструмента
...
### 6.1. Разделить `tool_platform/gui.py`
...
### 6.2. Стандартизировать данные статусов
...
### 6.3. Сделать единый индекс артефактов
...
### 6.4. Вынести блокировки профиля в отдельный модуль
...
### 6.5. Отвязать объединённый сценарий от временного состояния панели
